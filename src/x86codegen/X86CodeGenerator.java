...
//    block.insertOperAfter(oper1, oper2);
    ...
    if (frameSize > 0) {
      ...
      Operand src1 = new Operand(Operand.OperandType.INTEGER, (Integer)(frameSize));
    ...
    for (FuncParam currParam = func.getfirstParam(); currParam != null;
      ...
      Operand src1 = new Operand(Operand.OperandType.INTEGER, (Integer)(paramOffset));
      loadOper.setSrcOperand(1, src1);
      Operand dest0 = new Operand(Operand.OperandType.REGISTER, (Integer)(regNum));
...
//    }
  ...
  public void x86ConvertComparisonOper(Operation oper) {
    ...
    if (oper.getSrcOperand(0).getType() == Operand.OperandType.INTEGER) {
      ...
      Operand dest = new Operand(Operand.OperandType.REGISTER, (Integer)(regNum));
    ...
    if (oldBranch == null ||
      ...
      newOper.setSrcOperand(0, new Operand(Operand.OperandType.INTEGER, (Integer)(0)));
      ...
      setZero.setSrcOperand(0, new Operand(Operand.OperandType.INTEGER, (Integer)(1)));
  ...
  public void x86ConvertDivOper(Operation oper) {
    ...
    zero.setSrcOperand(0, new Operand(Operand.OperandType.INTEGER, (Integer)(0)));
  ...
  private void x86ConvertCallOper(Operation currOper) {
    ...
    if (numParams > 0) {
      ...
      Operand src1 = new Operand(Operand.OperandType.INTEGER, (Integer)(offset));
